...
public interface DistanceCalc {
     ...
     * rounding errors it cannot properly detect if it is case 1 or 90¡Æ.
     * <pre>
     * case 1 (including ):
     *   r
     *  .
     ...
     * </pre>
     *
     * @return true for case 1 which is "on edge" or the special case of 90¡Æ to the edge
     */
    ...
    /*
     * Simple heuristic to detect if the specified two points are crossing the boundary +-180¡Æ. See
     * #667
     */
